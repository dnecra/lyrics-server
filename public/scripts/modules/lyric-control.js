...
export function createLyricControlPanel() {
    ...
    const ICONS = {
        ...
        corner: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><g transform="rotate(90 12 12)"><path d="M18 8L22 12L18 16"/><line x1="2" y1="12" x2="22" y2="12"/></g></svg>`,
    ...
    widthControl.appendChild(btn(
        'lyrics-corner-toggle',
        'Switch lyric corner anchor',
        'Corner',
        ICONS.corner
    ));
    widthControl.appendChild(btn(
...
export function initLyricControlPanel(deps = {}) {
    ...
    const cornerToggle = document.getElementById('lyrics-corner-toggle');
    ...
    addButtonClick(cornerToggle, () => deps.toggleLyricCornerAnchor?.());
